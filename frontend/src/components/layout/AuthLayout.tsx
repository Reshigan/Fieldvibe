  ...
  return (
    <div className="min-h-screen bg-slate-950 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0A0F1C] via-[#0F1629] to-[#141C33]"></div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          <div>
            <Link to="/" className="inline-flex items-center space-x-3 group">
              ...
              <div>
                ...
                <p className="text-[#C8D4E8] text-xs">Enterprise Platform</p>
              </div>
            </Link>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-[#C8D4E8] leading-relaxed max-w-md">
            ...
            <div className="flex items-center space-x-8 pt-4">
              <div>
                ...
                <div className="text-[#C8D4E8] text-sm">Companies</div>
              </div>
              <div className="w-px h-12 bg-white/20"></div>
              <div>
                <div className="text-3xl font-bold text-white">50K+</div>
                <div className="text-[#C8D4E8] text-sm">Field Agents</div>
              </div>
              <div className="w-px h-12 bg-white/20"></div>
              <div>
                <div className="text-3xl font-bold text-white">99.9%</div>
                <div className="text-[#C8D4E8] text-sm">Uptime</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-[#C8D4E8] text-sm">Trusted by enterprises in 25+ countries</span>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-10 text-center">
            <Link to="/" className="inline-flex items-center justify-center space-x-3">
              <div className="w-12 h-12 bg-[#00E87B] rounded-xl flex items-center justify-center">
                <Zap className="w-7 h-7 text-white" />
              </div>
              <span className="text-2xl font-bold text-white">FieldVibe</span>
            </Link>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center space-x-2 bg-slate-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-700/50">
              ...
              <code className="text-[#00E87B] text-sm font-mono">Admin@2026!</code>
            </div>
          </div>
