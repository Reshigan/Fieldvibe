      ...
      <div className="min-h-screen bg-[#06090F]">
        <Routes>
          ...
          <Route element={
            ...
            <Route path="field-operations/visits/stores" element={<PageLoader><VisitManagementPage /></PageLoader>} />
            <Route path="field-operations/visits/individuals" element={<PageLoader><VisitManagementPage /></PageLoader>} />
